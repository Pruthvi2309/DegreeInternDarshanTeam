...
function KidsTshirt() {
  ...
  return (
    <Wrapper>
    <div className='Kids-TShirts'>
    <div className='heading'>
    <h1 className='header-text'>Kids-TShirts</h1>
    </div>
...
.Kids-TShirts .heading .header-text{
  margin-top: 18rem;
  color: black;
  text-align: center;
