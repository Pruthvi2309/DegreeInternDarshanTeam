...
// import './KidsTrouser.css'
function KidsTrouser() {
  ...
  return (
    <Wrapper>
    <div className='Kids-Trouser'>
    <div className='heading'>
    <h1 className='header-text'>Kids-Trouser</h1>
    </div>
...
.Kids-Trouser .heading .header-text{
  margin-top: 18rem;
  color: black;
  text-align: center;
