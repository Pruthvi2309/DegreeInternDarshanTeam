...
function WomenTrouser() {
  ...
  return (
    <Wrapper>
    <div className='Women-Trouser'>
    <div className='heading'>
    <h1 className='header-text'>Women-Trouser</h1>
    </div>
...
.Women-Trouser .heading .header-text{
  margin-top: 18rem;
  color: black;
  text-align: center;
